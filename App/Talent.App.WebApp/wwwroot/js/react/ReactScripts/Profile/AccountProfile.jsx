...
export default class AccountProfile extends React.Component {
    ...
    loadData() {
        ...
        console.log(cookies)
        $.ajax({
            url: 'https://talentservicesprofilecblim.azurewebsites.net/profile/profile/getTalentProfile',
            headers: {
    ...
    saveProfile(newProfile) {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentservicesprofilecblim.azurewebsites.net/profile/profile/updateTalentProfile',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
                            ...
                            <div className="profile">
                                <form className="ui form">
                                    <div className="ui grid">
                                        ...
                                        <FormItemWrapper
                                            title='Description'
                                            tooltip='Write a description of yourself'
                                        >
                                            <Description
                                        ...
                                        >
                                            <PhotoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                savePhotoUrl='https://talentservicesprofilecblim.azurewebsites.net/profile/profile/updateProfilePhoto'
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='Profile Video'
                                        ...
                                        >
                                            <VideoUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveVideoUrl={'https://talentservicesprofilecblim.azurewebsites.net/profile/profile/updateTalentVideo'}
                                            />
                                        </FormItemWrapper>
                                        <FormItemWrapper
                                            title='CV'
                                        ...
                                        >
                                            <CVUpload
                                                ...
                                                updateProfileData={this.updateWithoutSave}
                                                saveCVUrl={'https://talentservicesprofilecblim.azurewebsites.net/profile/profile/updateTalentCV'}
                                            />
                                        </FormItemWrapper>
                                        <SelfIntroduction
                                            summary={this.state.profileData.summary}
